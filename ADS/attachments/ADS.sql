...
-- --------------------------------------------------
-- Date Created: 07/24/2015 18:34:15
-- Generated from EDMX file: C:\Users\RPSR\documents\visual studio 2013\Projects\Algarve Destino Seguro\ADS\Models\Database.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_EntityLanguageLanguage]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EntityLanguageSet] DROP CONSTRAINT [FK_EntityLanguageLanguage];
GO
IF OBJECT_ID(N'[dbo].[FK_EntityLanguageEntity]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EntityLanguageSet] DROP CONSTRAINT [FK_EntityLanguageEntity];
GO
...
GO
IF OBJECT_ID(N'[dbo].[EntityLanguageSet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[EntityLanguageSet];
GO
...
CREATE TABLE [dbo].[Phrase] (
    ...
    [LanguageCode] nvarchar(8)  NOT NULL,
    [PhraseCode] nvarchar(64)  NOT NULL,
...
CREATE TABLE [dbo].[User] (
    ...
    [Name] nvarchar(64)  NOT NULL,
    [Password] nvarchar(192)  NOT NULL,
    [RoleType] nvarchar(64)  NOT NULL
);
GO
...
-- Creating primary key on [Email] in table 'User'
ALTER TABLE [dbo].[User]
ADD CONSTRAINT [PK_User]
    PRIMARY KEY CLUSTERED ([Email] ASC);
GO

-- Creating primary key on [Type] in table 'Role'
...
-- Creating foreign key on [RoleType] in table 'User'
ALTER TABLE [dbo].[User]
